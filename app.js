...
const demoAccounts = [
  { name: "Maya Patel", id: "A1234", edc: "2027-01-02", recordDate: "2026-07-13", babySize: "an apple", development: "Your baby's facial muscles are becoming more active and hearing is beginning to develop.", appointment: ["2026-07-18", "10:30 AM", "Midwife appointment"], investigation: ["2026-08-10", "9:20 AM", "Morphology scan", "Detailed fetal anatomy ultrasound."], followUp: ["2026-09-14", "Glucose screening", "Blood tests for gestational diabetes and anaemia."] },
  { name: "Chloe Wong", id: "B2345", edc: "2027-02-14", recordDate: "2026-09-13", babySize: "a bell pepper", development: "Your baby is moving actively and the ears are settling into their final position.", appointment: ["2026-09-18", "2:15 PM", "Obstetric clinic review"], investigation: ["2026-09-28", "11:00 AM", "Detailed anomaly scan", "A detailed review of fetal structures and growth."], followUp: ["2026-11-22", "Oral glucose tolerance test", "Fasting glucose assessment and blood sampling."] },
  { name: "Sophie Chan", id: "C3456", edc: "2027-03-20", recordDate: "2026-10-24", babySize: "a mango", development: "Your baby's movements are stronger and a protective coating is forming on the skin.", appointment: ["2026-10-30", "9:45 AM", "Ultrasound review clinic"], investigation: ["2026-11-02", "3:10 PM", "Placental localisation scan", "Checks placental position and fetal growth."], followUp: ["2026-12-20", "Full blood count", "Checks haemoglobin and iron status."] },
  { name: "Emma Lee", id: "D4567", edc: "2027-04-18", recordDate: "2026-12-06", babySize: "a banana", development: "Your baby can swallow and is developing more regular sleep and wake patterns.", appointment: ["2026-12-12", "4:00 PM", "Maternal medicine review"], investigation: ["2026-12-20", "1:30 PM", "Fetal echocardiogram", "A specialist ultrasound assessment of the baby's heart."], followUp: ["2027-01-30", "Glucose tolerance test", "Screens for gestational diabetes."] },
  { name: "Olivia Lam", id: "E5678", edc: "2027-05-22", recordDate: "2027-02-06", babySize: "a cauliflower", development: "Your baby is gaining body fat and responding to familiar voices and sounds.", appointment: ["2027-02-11", "10:00 AM", "Midwife continuity visit"], investigation: ["2027-02-15", "8:30 AM", "Gestational diabetes screening", "Glucose testing with timed blood samples."], followUp: ["2027-03-13", "Rhesus antibody review", "Blood group and antibody status review where relevant."] },
  { name: "Grace Ho", id: "F6789", edc: "2027-06-18", recordDate: "2027-04-03", babySize: "a butternut squash", development: "Your baby's lungs and nervous system continue to mature while movements remain strong.", appointment: ["2027-04-08", "11:20 AM", "Third-trimester clinic"], investigation: ["2027-04-10", "2:40 PM", "Fetal growth scan", "Measures fetal growth, fluid and placental blood flow."], followUp: ["2027-04-24", "Repeat blood count", "Checks haemoglobin and platelet levels."] },
  { name: "Hannah Ng", id: "G7890", edc: "2027-07-16", recordDate: "2027-05-22", babySize: "a squash", development: "Your baby is practising breathing movements and has developed fingernails and toenails.", appointment: ["2027-05-27", "9:10 AM", "Birth preparation visit"], investigation: ["2027-05-29", "10:50 AM", "Growth and Doppler scan", "Reviews growth and blood flow through the placenta."], followUp: ["2027-06-05", "Group B streptococcus discussion", "Explains testing and intrapartum care options."] },
  { name: "Isabella Cheung", id: "H8901", edc: "2027-08-20", recordDate: "2027-07-09", babySize: "a cantaloupe", development: "Your baby's brain is developing rapidly and the lungs continue preparing for birth.", appointment: ["2027-07-13", "3:00 PM", "Late pregnancy assessment"], investigation: ["2027-07-15", "9:30 AM", "Fetal presentation scan", "Confirms baby's position, growth and fluid volume."], followUp: ["2027-07-27", "Group B streptococcus swab", "A swab offered according to local clinical guidance."] },
  { name: "Zoe Lau", id: "J9012", edc: "2027-09-17", recordDate: "2027-08-20", babySize: "a head of romaine lettuce", development: "Your baby is putting on weight and may move lower into the pelvis in preparation for birth.", appointment: ["2027-08-23", "1:45 PM", "36-week obstetric visit"], investigation: ["2027-08-24", "10:15 AM", "Presentation ultrasound", "Confirms fetal presentation and placental position."], followUp: ["2027-08-27", "Cardiotocography", "Monitors the baby's heart rate when clinically indicated."] },
  { name: "Natalie Yip", id: "K0123", edc: "2027-10-23", recordDate: "2027-10-09", babySize: "a small pumpkin", development: "Your baby is close to term, continuing to gain weight and preparing for delivery.", appointment: ["2027-10-11", "8:50 AM", "Term pregnancy review"], investigation: ["2027-10-12", "11:40 AM", "Antenatal fetal monitoring", "Monitors fetal heart rate and uterine activity if indicated."], followUp: ["2027-10-16", "Delivery planning review", "Confirms birth preferences and post-date arrangements."] },
];
